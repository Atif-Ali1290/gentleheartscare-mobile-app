  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-red-50 to-white p-6">
      ...
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-red-700 ml-4">Provider Sign Up (1/2)</h1>
      </div>

      <div className="flex-1 overflow-y-auto space-y-6 pb-8">
        <div>
          <Label htmlFor="fullName" className="text-base font-medium text-red-700 mb-2 flex items-center">
        ...
        <div>
          <Label htmlFor="email" className="text-base font-medium text-red-700 mb-2 flex items-center">
        ...
        <div>
          <Label htmlFor="specialty" className="text-base font-medium text-red-700 mb-2 flex items-center">
            <Stethoscope className="h-4 w-4 mr-2 text-red-400" />
            Specialty
          </Label>
          <Input
            id="specialty"
        ...
        <div>
          <Label htmlFor="experience" className="text-base font-medium text-red-700 mb-2 flex items-center">
        ...
        <div>
          <Label htmlFor="bio" className="text-base font-medium text-red-700 mb-2 flex items-center">
            <User className="h-4 w-4 mr-2 text-red-400" />
            Short Bio
          </Label>
          <Textarea
            ...
            rows={4}
            className="text-base border-red-200 focus:border-red-400 focus:ring-red-400"
          />
        </div>
      </div>

      <div className="mt-auto py-4">
        <Button className="w-full h-12 bg-red-600 hover:bg-red-700 text-lg font-semibold text-white shadow" onClick={handleNext}>
